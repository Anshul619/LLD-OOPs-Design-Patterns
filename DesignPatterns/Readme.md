...
| :star: [Strategy](https://refactoring.guru/design-patterns/strategy)                          | Behavioral Patterns | - Pluggable components (like recommendations, load balancing , cache eviction strategies (lru, lfu etc.)) <br/>- Payment Gateways<br/>- Sorting strategies<br/>- Compression algorithms         | Design design with interchangeable behaviors                                  | Strategy lets you define a family of algorithms, put each of them into a separate class, and make their objects interchangeable.                                                                                  |
