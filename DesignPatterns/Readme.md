...
| :star: [Strategy](https://refactoring.guru/design-patterns/strategy)                          | Behavioral Patterns | - Pluggable components (like cache eviction strategies - lru, lfu, recommendations, load balancing) <br/>- Payment Gateways<br/>- Sorting strategies<br/>- Compression algorithms | Design with interchangeable behaviors                                                                             | Strategy lets you define a family of algorithms, put each of them into a separate class, and make their objects interchangeable.                                                                                  |
| :star: [Factory Method](https://www.geeksforgeeks.org/factory-method-design-pattern-in-java/) | Creational Patterns | - DB factory (Postgres vs MySQL) <br/>- NotificationFactory<br/>- Frameworks<br/>- Payment Processor factory in ecommerce backend                                                 | Abstraction, Decoupling of object creation from usage                                                             | Factory Method provides an interface for creating objects in a superclass, but allows subclasses to alter the type of objects that will be created.                                                               |
...
|---------------------------------------------------------------------------------------------|
| [Go](https://github.com/Anshul619/LLD-OOPs-Design-Patterns-Go/tree/main/DesignPatterns)     |
| [Java](https://github.com/Anshul619/LLD-OOPs-Design-Patterns-Java/tree/main/DesignPatterns) |
